      ...
      <View style={{ backgroundColor: COLORS.primary, height: SIZES.height }}>
        ...
        >
          ...
          <RegistrationTile
            ...
            desc={"Join our community and showcase your culinary delights to a wider audience."}
          />
          ...
          <RegistrationTile
            ...
            desc={"Embark on a journey, deliver joy, and earn on your own schedule."}
          />
          ...
          >
            <ProfileTile title={"Shipping Address"} icon={"location-outline"} font={1} />
